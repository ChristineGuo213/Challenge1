...
def calculate_fair_present_value(home_price, future_value, annual_discount_rate, remaining_months):
    annual_discount_rate = 0.2
    fair_present_value = future_value / (1 + (annual_discount_rate / 12)) ** remaining_months

# If Present Value represents what the loan is really worth, does it make sense to buy the loan at its cost?
# @TODO: Write a conditional statement (an if-else statement) to decide if the present value represents the loan's fair value.
#    If the present value of the loan is greater than or equal to the cost, then print a message that says the loan is worth at least the cost to buy it.
#    Else, the present value of the loan is less than the loan cost, then print a message that says that the loan is too expensive and not worth the price.
    if fair_present_value >= home_price:
        print("The loan is worth at least the cost to buy it.")

    elif fair_present_value < home_price:
...
pv = calculate_present_value(1000, 0.2, 12)
